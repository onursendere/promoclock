    ...
    hooks: {
      "astro:build:done": async ({ dir, logger }) => {
        ...
        const lines = [
          ...
          `  RewriteRule ^(deals|tools|calendar|affiliate-disclosure|about)/?$ /${defaultLocale}/$1/ [R=301,L]`,
          `  RewriteRule ^(deals|tools|calendar|affiliate-disclosure|about)(/.+)$ /${defaultLocale}/$1$2 [R=301,L]`,
          "",
          "  # Root → saved language, then browser language, then English.",
          `  RewriteCond %{HTTP_COOKIE} (?:^|;\\s*)(?:NEXT_)?LOCALE=(${localeAlternation})(?:;|$)`,
