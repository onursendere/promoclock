...
export default function CoworkBoostBanner({ dict }: Props) {
  const b = dict.coworkBoost;

  // Not yet translated for this language — render nothing (graceful staged rollout).
  if (!b) return null;
  ...
  return (
    <section className="px-4 pb-10 sm:pb-14">
      ...
      >
        <div className="relative overflow-hidden rounded-3xl border border-[rgba(15,61,58,0.2)] bg-linear-to-br from-[#0f3d3a] via-[#0d4f4a] to-[#11706a] text-white shadow-[0_8px_40px_rgba(15,61,58,0.25)]">
          {/* Decorative shimmer */}
          <motion.div
            aria-hidden
          ...
          <div className="relative z-10 p-6 sm:p-8 md:p-10 flex flex-col items-center text-center gap-3 sm:gap-4">
            <div className="flex flex-wrap items-center justify-center gap-2">
              ...
              <span className="text-[10px] sm:text-[11px] font-bold tracking-[0.18em] uppercase bg-emerald-300/90 text-[#0f3d3a] px-3 py-1 rounded-full">
                {b.scope}
              </span>
            </div>
            ...
            <div className="mt-3 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs sm:text-sm text-white/70">
              <a
                href="https://support.claude.com/en/articles/15400594-claude-cowork-june-2026-usage-promotion"
                target="_blank"
