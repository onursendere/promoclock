...
export async function getDeals(): Promise<DealRecord[]> {
  ...
  return entries.map(({ id, data }) => ({
    ...
    headline: data.headline as DealRecord["headline"],
    value: data.value as DealRecord["value"],
    audience: data.audience as DealRecord["audience"],
    summary: data.summary as DealRecord["summary"],
    scope: data.scope as DealRecord["scope"],
    steps: data.steps as DealRecord["steps"],
    terms: data.terms as DealRecord["terms"],
    code: data.code,
